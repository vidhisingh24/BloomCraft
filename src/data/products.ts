...
export const KEYCHAINS_DATA: Product[] = [
  ...
  {
    id: "kc-avocado",
    name: "Happy Avocado Charm",
    category: "keychains",
    keychainType: "others",
    price: 229,
    originalPrice: 269,
    description: "Cheerful handmade avocado slice charm with round brown seed core, green rind, and sweet stitched blush cheeks.",
    image: "https://images.unsplash.com/photo-1567653418876-5bb0e566e1c2?auto=format&fit=crop&w=700&q=80",
    tags: ["Cute Fruit", "Happy Charm"],
    yarnType: "Soft Combed Cotton",
    dimensions: "5.5 cm x 4 cm",
    inStock: true,
    colors: ["Fresh Lime & Brown", "Pastel Mint"],
  },
];
