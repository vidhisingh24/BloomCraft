...
export const INITIAL_PRODUCTS: DashboardProduct[] = [
  {
    ...
    description: 'Two-tone handcrafted twin tulip bells in pure white and vibrant magenta pink.',
  },
  {
    ...
    description: 'Vibrant matching pair of magenta pink crochet tulip bells with leaf bow.',
  },
  {
    ...
    description: 'Refreshing ocean sky blue twin tulip blossoms handcrafted with milk cotton yarn.',
  },
  {
    ...
    description: 'Dreamy lavender purple double tulip bells with hand-stitched green stem.',
  },
  {
    id: 'kc-tulip-red-duo',
    ...
    description: 'Classic romantic crimson red double tulip bells with emerald green crochet stem.',
  },
  {
