    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-0 sm:pl-10">
        <div className="w-screen max-w-md bg-[#FFFDFB] shadow-2xl border-l border-[#F4A6B7]/30 flex flex-col">
          ...
          {/* Header */}
          <div className="p-4 sm:p-5 bg-gradient-to-r from-[#FFE3E8]/60 to-[#FFF0F3] border-b border-rose-100 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h2 className="font-serif text-lg font-bold text-[#3D272A]">Saved Favorites</h2>
            ...
            {wishlistProducts.length === 0 ? (
              ...
              <div className="space-y-3">
                {wishlistProducts.map((product) => (
                  <div
                    key={product.id}
                    className="flex gap-3.5 p-3.5 rounded-2xl bg-white border border-rose-100 shadow-xs items-center"
                  >
                    <img
                      src={product.images?.[0] || '/images/keychains/tulip_pink_duo.jpg'}
                      alt={product.name}
